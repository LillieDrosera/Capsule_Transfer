...
function Save_Info($infoFile, $sql){
      ...
      $request_1 = 'INSERT INTO `Capsule_File`(`Id_Folder`,`Name`,`Format`,`Date_Upload`,`Validity`,`Nb_Download`,`Size`,`Id_user`) VALUES ( :Id_Folder, :Name, :Format, NULL, NULL, NULL, :Size, NULL)';
